...
<body>
  ...
  <section>
    ...
    <div class="price-menu" style="display: grid; grid-template-columns: auto auto auto auto;">
      <div class="price-menu-item" onclick="scrollFunction(800,800)">
      ...
      <div class="price-menu-item" onclick="scrollFunction(1500,1500)">
      ...
      <div class="price-menu-item" onclick="scrollFunction(2100,2100)">
      ...
      <div class="price-menu-item" onclick="scrollFunction(2100,2100)">
        ...
        <p>รักษาโรคเหงือก & รักษาคลองรากฟัน(RCT)</p>
      </div>
      <div class="price-menu-item" onclick="scrollFunction(2900,2900)">
        <img src="assets/images/price/ฟันปลอม.jpg" alt="" style="width: 250px; height:200px">
        <p>ฟันปลอม</p>
      </div>
      <div class="price-menu-item" onclick="scrollFunction(3700,3700)">
...
<script>
  // ควบคุม หัวข้อใหญ่ด้านบน
  // scrollFunction  Start
  function scrollFunction(num1, num2) {
    document.body.scrollTop = num1; // For Safari
    document.documentElement.scrollTop = num2; // For Chrome, Firefox, IE and Opera
  }
  // scrollFunction  End
  // ----------------------------------------------------------------------------
